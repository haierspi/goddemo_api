...
func (l *Logger) DDebug(v ...interface{}) {
	l.WithTrace().Output(LevelDebug, fmt.Sprint(v...))
}

func (l *Logger) DDebugf(format string, v ...interface{}) {
	l.WithTrace().Output(LevelDebug, fmt.Sprintf(format, v...))
}

func (l *Logger) DInfo(v ...interface{}) {
	l.WithTrace().Output(LevelInfo, fmt.Sprint(v...))
}

func (l *Logger) DInfof(format string, v ...interface{}) {
	l.WithTrace().Output(LevelInfo, fmt.Sprintf(format, v...))
}

func (l *Logger) DWarn(v ...interface{}) {
	l.WithTrace().Output(LevelWarn, fmt.Sprint(v...))
}

func (l *Logger) DWarnf(format string, v ...interface{}) {
	l.WithTrace().Output(LevelWarn, fmt.Sprintf(format, v...))
}

func (l *Logger) DError(v ...interface{}) {
	l.WithTrace().Output(LevelError, fmt.Sprint(v...))
}

func (l *Logger) DErrorf(format string, v ...interface{}) {
	l.WithTrace().Output(LevelError, fmt.Sprintf(format, v...))
}

func (l *Logger) DFatal(v ...interface{}) {
	l.WithTrace().Output(LevelFatal, fmt.Sprint(v...))
}

func (l *Logger) DFatalf(format string, v ...interface{}) {
	l.WithTrace().Output(LevelFatal, fmt.Sprintf(format, v...))
}

func (l *Logger) DPanic(v ...interface{}) {
	l.WithTrace().Output(LevelPanic, fmt.Sprint(v...))
}
