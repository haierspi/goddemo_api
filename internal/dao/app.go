...
import (
	...
	"starfission_go_api/internal/model/starfission/app_repo"
...
func (d *Dao) GetAppByID(appId int64) (*App, error) {

	m, err := app_repo.NewQueryBuilder().
	...
	return convert.StructAssign(m, &App{}).(*App), nil
